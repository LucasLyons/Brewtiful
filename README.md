...
Both LightFM and standard SVD models also learn *bias terms* to give a boost to high quality items. But how are the embeddings and bias terms used to serve recommendations? Before answering that question, we'll briefly digress to the subject of the training data for the LightFM model.
